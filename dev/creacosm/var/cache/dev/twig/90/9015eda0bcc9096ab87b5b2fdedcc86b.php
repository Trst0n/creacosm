...
class __TwigTemplate_6d18da65f7f858c6043ef81db4ab749c extends Template
{
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "sondage/_form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block body %}
    ...
    {{ include('sondage/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_sondage_index') }}\">back to list</a>

    {{ include('sondage/_delete_form.html.twig') }}
{% endblock %}
", "sondage/edit.html.twig", "/var/www/html/creacosm/templates/sondage/edit.html.twig");
    }
}
