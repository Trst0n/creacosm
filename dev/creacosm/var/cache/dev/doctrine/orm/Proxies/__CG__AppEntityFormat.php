 ...
 */
class Format extends \App\Entity\Format implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'format' => [parent::class, 'format', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        'format' => [parent::class, 'format', null],
