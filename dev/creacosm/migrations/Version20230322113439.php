 ...
 */
final class Version20230322113439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sondage (id INT NOT NULL, theme_id INT DEFAULT NULL, createur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, introduction VARCHAR(255) DEFAULT NULL, visibilite BOOLEAN NOT NULL, datecreation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
