 ...
 */
final class Version20230323161101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, visuel_id INT DEFAULT NULL, type_id INT NOT NULL, sondage_id INT DEFAULT NULL, intitule VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE sondage (id INT NOT NULL, theme_id INT DEFAULT NULL, administrateur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, introduction VARCHAR(255) DEFAULT NULL, visibilite BOOLEAN NOT NULL, datecreation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7579C89F59027487 ON sondage (theme_id)');
        $this->addSql('CREATE INDEX IDX_7579C89F7EE5403C ON sondage (administrateur_id)');
        ...
        $this->addSql('CREATE TABLE statistique (id INT NOT NULL, format_id INT NOT NULL, sondage_id INT NOT NULL, titre VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT NOT NULL, login VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, genre VARCHAR(255) DEFAULT NULL, datedenaissance TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1D1C63B3AA08CB10 ON utilisateur (login)');
        $this->addSql('CREATE TABLE utilisateur_reponse (utilisateur_id INT NOT NULL, reponse_id INT NOT NULL, PRIMARY KEY(utilisateur_id, reponse_id))');
        $this->addSql('CREATE INDEX IDX_25BD2955FB88E14F ON utilisateur_reponse (utilisateur_id)');
        $this->addSql('CREATE INDEX IDX_25BD2955CF18BB82 ON utilisateur_reponse (reponse_id)');
        ...
        $this->addSql('ALTER TABLE sondage ADD CONSTRAINT FK_7579C89F7EE5403C FOREIGN KEY (administrateur_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE utilisateur_reponse ADD CONSTRAINT FK_25BD2955FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE utilisateur_reponse ADD CONSTRAINT FK_25BD2955CF18BB82 FOREIGN KEY (reponse_id) REFERENCES reponse (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sondage DROP CONSTRAINT FK_7579C89F7EE5403C');
        ...
        $this->addSql('ALTER TABLE utilisateur_reponse DROP CONSTRAINT FK_25BD2955FB88E14F');
        $this->addSql('ALTER TABLE utilisateur_reponse DROP CONSTRAINT FK_25BD2955CF18BB82');
        ...
        $this->addSql('DROP TABLE utilisateur_reponse');
